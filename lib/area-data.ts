...
export const kauaiAreas: Record<string, AreaData> = {
  "east-side": {
    ...
    description:
      "Reach up to 8,000 East Side Kauai homes with a premium 9×12 postcard. Island Mailer puts your Kapaa or Wailua business in front of local residents - design, print & postage included for $800.",
    query: "East Side",
    region: "East Side Kauai",
    island: "Kauai",
    islandSlug: "kauai",
    homesEstimate: 8000,
    heroImg: IMG("1633511090164"),
    ...
    hoodPhoto: { src: IMG("1633511090164"), alt: "Kapaa and the Coconut Coast — the East Side of Kauai." },
  ...
  "north-shore": {
    ...
    description:
      "Reach up to 3,300 North Shore Kauai homes with a premium 9×12 postcard. Island Mailer puts your Hanalei or Princeville business in front of local residents - design, print & postage included for $800.",
    query: "North Shore",
    region: "North Shore Kauai",
    island: "Kauai",
    islandSlug: "kauai",
    homesEstimate: 3300,
    heroImg: IMG("1505852679233"),
    ...
    hoodsHeading: "Neighborhoods We Reach on the North Shore",
    hoodPhoto: { src: IMG("1505852679233"), alt: "Hanalei Bay and the lush North Shore cliffs of Kauai." },
  ...
  "south-shore": {
    ...
    description:
      "Reach up to 5,000 South Shore Kauai homes with a premium 9×12 postcard. Island Mailer puts your Poipu or Koloa business in front of local residents - design, print & postage included for $800.",
    query: "South Shore",
    region: "South Shore Kauai",
    island: "Kauai",
    islandSlug: "kauai",
    homesEstimate: 5000,
    heroImg: IMG("1542309174-d33b34ce6ea7"),
    ...
    hoodPhoto: { src: IMG("1542309174-d33b34ce6ea7"), alt: "Sunny Poipu Beach — the South Shore of Kauai." },
  ...
  "west-side": {
    ...
    description:
      "Reach up to 4,100 West Side Kauai homes with a premium 9×12 postcard. Island Mailer puts your Waimea or Hanapepe business in front of local residents - design, print & postage included for $800.",
    query: "West Side",
    region: "West Side Kauai",
    island: "Kauai",
    islandSlug: "kauai",
    homesEstimate: 4100,
    heroImg: IMG("1531226208074"),
    ...
    hoodPhoto: { src: IMG("1531226208074"), alt: "Waimea Canyon overlook — the West Side of Kauai." },
  ...
  lihue: {
    ...
    description:
      "Reach up to 6,800 Lihue Kauai homes with a premium 9×12 postcard. Island Mailer puts your Lihue business in front of local residents - design, print & postage included for $800.",
    query: "Lihue",
    region: "Lihue Kauai",
    island: "Kauai",
    islandSlug: "kauai",
    homesEstimate: 6800,
    heroImg: IMG("1668022696969"),
    heroAlt: "Lihue - Kauai",
    tag: "Lihue - Kauai",
    ...
    hoodPhoto: { src: IMG("1668022696969"), alt: "Lihue town and Nawiliwili Harbor — the hub of Kauai." },
...
export const oahuAreas: Record<string, AreaData> = {
  "north-shore": {
    ...
    description:
      "Reach up to 7,500 North Shore Oahu homes with a premium 9×12 postcard. Island Mailer puts your Haleiwa or Kahuku business in front of local residents - design, print & postage included for $800.",
    query: "North Shore",
    region: "North Shore Oahu",
    island: "Oahu",
    islandSlug: "oahu",
    homesEstimate: 7500,
    heroImg: IMG("1633511090690"),
    ...
    hoodsHeading: "Neighborhoods We Reach on the North Shore",
    hoodPhoto: { src: IMG("1633511090690"), alt: "Haleiwa and the North Shore country towns of Oahu." },
  ...
  windward: {
    ...
    description:
      "Reach up to 24,800 Windward Oahu homes with a premium 9×12 postcard. Island Mailer puts your Kailua or Kaneohe business in front of local residents - design, print & postage included for $800.",
    query: "Windward",
    region: "Windward Oahu",
    island: "Oahu",
    islandSlug: "oahu",
    homesEstimate: 24800,
    heroImg: IMG("1599027619757"),
    ...
    hoodPhoto: { src: IMG("1599027619757"), alt: "The lush Koolau cliffs over Windward Oahu." },
  ...
  central: {
    ...
    description:
      "Reach up to 25,200 Central Oahu homes with a premium 9×12 postcard. Island Mailer puts your Mililani or Wahiawa business in front of local residents - design, print & postage included for $800.",
    query: "Central",
    region: "Central Oahu",
    island: "Oahu",
    islandSlug: "oahu",
    homesEstimate: 25200,
    heroImg: IMG("1576567559946"),
    ...
    hoodPhoto: { src: IMG("1576567559946"), alt: "The red-earth pineapple fields of Central Oahu." },
  ...
  leeward: {
    ...
    description:
      "Reach up to 40,000 Leeward Oahu homes with a premium 9×12 postcard. Island Mailer puts your Kapolei or Ewa Beach business in front of local residents - design, print & postage included for $800.",
    query: "Leeward",
    region: "Leeward Oahu",
    island: "Oahu",
    islandSlug: "oahu",
    homesEstimate: 40000,
    heroImg: IMG("1520627900660"),
    ...
    hoodPhoto: { src: IMG("1520627900660"), alt: "The sunny Leeward coast of West Oahu." },
  ...
  honolulu: {
    ...
    description:
      "Reach up to 60,000 Honolulu homes with a premium 9×12 postcard. Island Mailer puts your Honolulu business in front of local residents - design, print & postage included for $800.",
    query: "Honolulu",
    region: "Honolulu Urban Oahu",
    island: "Oahu",
    islandSlug: "oahu",
    homesEstimate: 60000,
    heroImg: IMG("1547537352-ae90c682877e"),
    ...
    hoodPhoto: { src: IMG("1547537352-ae90c682877e"), alt: "Honolulu and Diamond Head from above." },
...
export const bigIslandAreas: Record<string, AreaData> = {
  hilo: {
    ...
    description:
      "Reach up to 17,200 Hilo homes with a premium 9×12 postcard. Island Mailer puts your Hilo or Keaau business in front of local residents - design, print & postage included for $800.",
    query: "Hilo",
    region: "Hilo Hawaii Island",
    island: "Big Island",
    islandSlug: "hawaii",
    homesEstimate: 17200,
    heroImg: IMG("1519834424588"),
    ...
    hoodPhoto: { src: IMG("1519834424588"), alt: "Historic Hilo Bay on the Big Island." },
  ...
  hamakua: {
    ...
    description:
      "Reach up to 2,600 Hamakua Coast homes with a premium 9×12 postcard. Island Mailer puts your Honokaa or Waipio business in front of local residents - design, print & postage included for $800.",
    query: "Hamakua",
    region: "Hamakua Coast Hawaii Island",
    island: "Big Island",
    islandSlug: "hawaii",
    homesEstimate: 2600,
    heroImg: IMG("1474574205529"),
    ...
    hoodPhoto: { src: IMG("1474574205529"), alt: "The green cliffs of the Hamakua Coast." },
  ...
  "south-kohala": {
    ...
    description:
      "Reach up to 7,000 South Kohala homes with a premium 9×12 postcard. Island Mailer puts your Waimea or Kohala Coast business in front of local residents - design, print & postage included for $800.",
    query: "South Kohala",
    region: "South Kohala Hawaii Island",
    island: "Big Island",
    islandSlug: "hawaii",
    homesEstimate: 7000,
    heroImg: IMG("1584077804610"),
    ...
    hoodPhoto: { src: IMG("1584077804610"), alt: "Waimea ranchlands of South Kohala." },
  ...
  "north-kona": {
    ...
    description:
      "Reach up to 15,300 North Kona homes with a premium 9×12 postcard. Island Mailer puts your Kailua-Kona business in front of local residents - design, print & postage included for $800.",
    query: "North Kona",
    region: "North Kona Hawaii Island",
    island: "Big Island",
    islandSlug: "hawaii",
    homesEstimate: 15300,
    heroImg: IMG("1545048984-76f238de07f6"),
    ...
    hoodPhoto: { src: IMG("1545048984-76f238de07f6"), alt: "Kailua-Kona on the West Hawaii coast." },
  ...
  "south-kona": {
    ...
    description:
      "Reach up to 4,000 South Kona homes with a premium 9×12 postcard. Island Mailer puts your Kealakekua or Captain Cook business in front of local residents - design, print & postage included for $800.",
    query: "South Kona",
    region: "South Kona Hawaii Island",
    island: "Big Island",
    islandSlug: "hawaii",
    homesEstimate: 4000,
    heroImg: IMG("1618452133663"),
    ...
    hoodPhoto: { src: IMG("1618452133663"), alt: "Coffee country above the South Kona coast." },
  ...
  puna: {
    ...
    description:
      "Reach up to 18,100 Puna homes with a premium 9×12 postcard. Island Mailer puts your Pahoa or Keaau business in front of local residents - design, print & postage included for $800.",
    query: "Puna",
    region: "Puna Hawaii Island",
    island: "Big Island",
    islandSlug: "hawaii",
    homesEstimate: 18100,
    heroImg: IMG("1576941026827"),
    ...
    hoodPhoto: { src: IMG("1576941026827"), alt: "The volcanic landscape of the Puna district." },
  ...
  kaau: {
    ...
    description:
      "Reach up to 3,400 Ka'u homes with a premium 9×12 postcard. Island Mailer puts your Naalehu or Pahala business in front of local residents - design, print & postage included for $800.",
    query: "Ka'u",
    region: "Ka'u Hawaii Island",
    island: "Big Island",
    islandSlug: "hawaii",
    homesEstimate: 3400,
    heroImg: IMG("1687845151607"),
    ...
    hoodPhoto: { src: IMG("1687845151607"), alt: "The remote south coast of the Ka'u district." },
...
export const islandConfigs: Record<string, IslandConfig> = {
  ...
  hawaii: {
    ...
    hubHeroImg: IMG("1542332213-9b5a5a3fad35"),
