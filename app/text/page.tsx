...
export default function TextOptIn() {
  return (
    <main style={{maxWidth:640,margin:"0 auto",padding:"80px 24px",textAlign:"center",fontFamily:"system-ui,sans-serif",color:"#262F40",lineHeight:1.7}}>
      <h1 style={{fontSize:32,color:"#1F2735"}}>Text with Island Mailer</h1>
